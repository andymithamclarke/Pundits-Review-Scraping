...
import modules.items as myitems
...
class ArticleSpider(scrapy.Spider):
	...
	def parse_article(self, response, media_source, characteristics, url):
		...
		for item in item_list:
			# # Create instance of Phrase Item
			# phrase_item = myitems.PhraseItem()

			# # Populate the phrase_item
			# phrase_item['date'] = item['date']
			# phrase_item['lemmatized_no_stopwords_phrase'] = item['lemmatized_no_stopwords_phrase']
			# phrase_item['media_source'] = item['media_source']
			# phrase_item['original_sentence'] = item['original_sentence']
			# phrase_item['phrase'] = item['phrase']
			# phrase_item['teams'] = item['teams']
			# phrase_item['time'] = item['time']
			# phrase_item['url'] = item['url']
			...
			# Only return the item if there is a target identified
